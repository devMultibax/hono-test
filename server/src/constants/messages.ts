...
export const MSG = {
  ...
  validation: {
    ...
    departments: {
      required: 'กรุณาระบุฝ่ายอย่างน้อย 1 รายการ',
      primaryRequired: 'ต้องมีฝ่ายหลัก (Primary) เพียง 1 รายการเท่านั้น',
      duplicate: 'ฝ่ายซ้ำกันไม่ได้',
      sectionMismatch: 'แผนกที่เลือกไม่ได้อยู่ภายใต้ฝ่ายที่ระบุ',
    },
    departmentName: {
  ...
  export: {
    user: {
      ...
      department: 'ฝ่าย',
      section: 'หน่วยงาน',
      additionalDepartments: 'ฝ่ายเพิ่มเติม',
      email: 'อีเมล',
      tel: 'เบอร์โทร',
      role: 'สิทธิ์',
      status: 'สถานะ',
  ...
  template: {
    ...
    user: {
      columns: {
        ...
        departmentId: 'รหัสฝ่ายหลัก (ตัวเลข)\nตัวอย่าง: 1\nดูรหัสได้จากหน้าจัดการฝ่าย',
        sectionId: 'รหัสหน่วยงานหลัก (ตัวเลข)\nตัวอย่าง: 1\nดูรหัสได้จากหน้าจัดการหน่วยงาน',
      ...
      instructions: {
        ...
        departmentId: {
          description: 'รหัสฝ่ายหลัก',
          rules: 'ตัวเลขมากกว่า 0, ต้องเป็นฝ่ายที่มีในระบบและสถานะใช้งาน',
        },
        sectionId: {
          description: 'รหัสหน่วยงานหลัก',
          rules: 'ตัวเลขมากกว่า 0, ต้องสังกัดฝ่ายที่ระบุ, เว้นว่างได้ถ้าไม่มีหน่วยงาน',
        },
        email: {
          description: 'อีเมล',
  ...
  errors: {
    ...
    user: {
      ...
      departmentsRequired: 'กรุณาระบุฝ่ายอย่างน้อย 1 รายการ',
      primaryRequired: 'ต้องมีฝ่ายหลัก (Primary) เพียง 1 รายการเท่านั้น',
      departmentsDuplicate: 'ฝ่ายซ้ำกันไม่ได้',
      sectionDeptMismatch: 'แผนกที่เลือกไม่ได้อยู่ภายใต้ฝ่ายที่ระบุ',
    },
    auth: {
